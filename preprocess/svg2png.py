...
def main():
    ...
    parser.add_argument('--train_01', type=str, help='Path to train_01 dataset')
    parser.add_argument('--test_00', type=str, help='Path to test_00 dataset')
    parser.add_argument('--svg_dir', type=str, help='Directory to save SVG files')
    parser.add_argument('--png_dir', type=str, help='Directory to save PNG files')
    ...
    # 根据新参数处理文件
    if args.train_00:
        print(f"Using train_00 dataset: {args.train_00}")
    if args.train_01:
        print(f"Using train_01 dataset: {args.train_01}")
    if args.test_00:
        print(f"Using test_00 dataset: {args.test_00}")
